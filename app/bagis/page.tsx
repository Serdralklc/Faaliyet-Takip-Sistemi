        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-[11px] font-black uppercase tracking-[0.20em]" style={{ color: BRAND.gold }}>Bağış</span>
            </div>
            ...
            <div className="flex items-start gap-4 p-5 rounded-2xl border mb-6" style={{ background: BRAND.gold + "10", borderColor: BRAND.gold + "40" }}>
              ...
              <p className="text-[14px] leading-[1.65]" style={{ color: b }}>
            ...
            <a href="/iletisim"
              className="inline-flex items-center gap-2 px-7 py-3.5 rounded-xl text-[14px] font-black text-white transition hover:opacity-90"
          ...
          <div className="grid grid-cols-2 gap-3">
            {alanlar.map(a => (
              <div key={a.baslik} className="p-6 rounded-2xl border" style={{ background: sr, borderColor: br }}>
                <div className="w-10 h-10 rounded-xl flex items-center justify-center mb-4" style={{ background: a.renk + "15" }}>
                ...
                <p className="font-black text-[14px] mb-2" style={{ color: h }}>{a.baslik}</p>
                <p className="text-[12.5px] leading-[1.60]" style={{ color: mu }}>{a.aciklama}</p>
              </div>
            ))}
          </div>
        </div>
