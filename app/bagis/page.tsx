...
import { MotionReveal, HoverReveal, Pressable, staggerContainer, staggerItem } from "@/components/motion";
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <MotionReveal as="div">
            ...
            <Pressable>
              <a
                href="/iletisim"
                className="inline-flex items-center gap-2 px-7 py-3.5 rounded-xl text-[14px] font-bold"
          ...
          >
            {alanlar.map(a => (
              <motion.div key={a.baslik} variants={staggerItem} style={{ height: "100%" }}>
                <HoverReveal
                  lift={6}
                  restShadow="0 2px 8px rgba(0,0,0,0.05)"
                  hoverShadow="0 16px 44px rgba(0,0,0,0.12)"
