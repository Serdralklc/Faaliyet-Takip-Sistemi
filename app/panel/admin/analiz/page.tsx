...
function metrikler(a: Record<string, number>) {
  return {
    toplamFaaliyet: (a.ls_toplamFaaliyet ?? 0) + (a.uni_toplamFaaliyet ?? 0),
    yeniIntisap:    (a.ls_yeniIntisap ?? 0) + (a.uni_yeniIntisap ?? 0),
    kafile:         (a.ls_kafileSayisi ?? 0) + (a.uni_kafileSayisi ?? 0) + (a.ortakKafileSayisi ?? 0),
    sabahNamazi:    (a.ls_sabahNamaziSayisi ?? 0) + (a.uni_sabahNamaziSayisi ?? 0) + (a.ortakSabahNamaziSayisi ?? 0),
    ilimDersi:      (a.ls_ilimDersYeri ?? 0) + (a.uni_ilimDersYeri ?? 0),
...
const ACT_SELECT = {
  ...
  ls_toplamFaaliyet: true, uni_toplamFaaliyet: true,
  ls_yeniIntisap: true, uni_yeniIntisap: true,
  ls_kafileSayisi: true, uni_kafileSayisi: true, ortakKafileSayisi: true,
  ls_sabahNamaziSayisi: true, uni_sabahNamaziSayisi: true, ortakSabahNamaziSayisi: true,
  ls_ilimDersYeri: true, uni_ilimDersYeri: true,
