...
const BIRIM_GRUPLARI: { baslik: string; renk: string; birim?: BirimKey; alanlar: { key: string; label: string }[] }[] = [
  ...
  },
  {
    ...
    alanlar: [
      ...
      { key: "ls_toplamFaaliyet", label: "Toplam Faaliyet" },
      { key: "ls_yeniIntisap", label: "Yeni İntisap" },
      { key: "ls_sabahNamaziSayisi", label: "Sabah Namazı (eski)" },
      { key: "ls_sabahNamaziKatilim", label: "SN Katılım (eski)" },
      { key: "ls_kafileSayisi", label: "Kafile (eski)" },
      { key: "ls_kafileOgrenci", label: "Kafile Öğr. (eski)" },
    ],
  },
  {
    ...
    alanlar: [
      ...
      { key: "uni_toplamFaaliyet", label: "Toplam Faaliyet" },
      { key: "uni_kykBulusmaSayisi", label: "KYK Buluşma" },
      { key: "uni_kykKatilim", label: "KYK Katılım" },
      { key: "uni_yeniIntisap", label: "Yeni İntisap" },
      { key: "uni_sabahNamaziSayisi", label: "Sabah Namazı (eski)" },
      { key: "uni_sabahNamaziKatilim", label: "SN Katılım (eski)" },
      { key: "uni_kafileSayisi", label: "Kafile (eski)" },
      { key: "uni_kafileOgrenci", label: "Kafile Öğr. (eski)" },
    ],
  },
  {
