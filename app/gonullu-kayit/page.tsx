    ...
    <div style={{ minHeight: "100dvh", background: COLORS.bg }} className="flex items-center justify-center px-4 py-12">
      <div style={{ background: COLORS.sr, border: `1px solid ${COLORS.br}`, borderRadius: "1.5rem", padding: "2.5rem", width: "100%", maxWidth: "560px" }}>
        ...
        <div className="text-center mb-8">
          ...
          <p style={{ color: COLORS.b, fontSize: "14px", marginTop: "4px" }}>Gönüllü sistemine kayıt olun</p>
        </div>
        ...
        {success ? (
          <div className="text-center py-8">
            ...
            <p style={{ color: COLORS.h, fontWeight: 700, fontSize: "1.1rem" }}>Kayıt Başarılı!</p>
            <p style={{ color: COLORS.b, fontSize: "14px", marginTop: "6px" }}>Giriş sayfasına yönlendiriliyorsunuz...</p>
          </div>
        ) : (
        ...
        <p style={{ textAlign: "center", color: COLORS.mu, fontSize: "13px", marginTop: "20px" }}>
